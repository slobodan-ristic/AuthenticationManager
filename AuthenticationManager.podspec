#
# Be sure to run `pod lib lint AuthenticationManager.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.author           = { 'slobodan-ristic' => 'slobodan.ristic@swiftylabs.io' }
  ...
  # s.resource_bundles = {
  #   'AuthenticationManager' => ['AuthenticationManager/Assets/*.png']
  # }
